 ...
 */
public class TrashShowMessageController {
    ...
    public void initialization() {
        btnSender.setText(message.getSenderOrRecipient());
    ...
    public void showProfileSender() {
        ...
        Image avatarSender;
        try {
            avatarSender = new Image(Database.getAvatar(Database.changeLoginOnID(message.getSenderOrRecipient())));
        } catch( NullPointerException e) {
            avatarSender = new Image("/images/service/person.png");
        }

        PopOverBuilder.showBalloonWithProfile(popOverProfile, Database.changeLoginOnID(message.getSenderOrRecipient()),
                avatarSender, Database.changeIDOnNameAndLastName(Database.changeLoginOnID(message.getSenderOrRecipient())),
                person);

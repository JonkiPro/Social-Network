 ...
 */
public class WorkingCopyShowMessageController {
    ...
    private Stage stage;
    private MessageWorkingCopy message;

    @FXML
    public void edit() {
        new LoadPage().loadWorkingCopyEditMessage(person, message);
    }
    ...
    public void initialization() {
        ...
        labelDate.setText(message.getSaveDate());
    }
    ...
    public void setMessage(MessageWorkingCopy messageWorkingCopy) {
        this.message = messageWorkingCopy;
    }
}
